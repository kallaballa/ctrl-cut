...
#ifndef CTRLCUTOPTIONS_H_
#define CTRLCUTOPTIONS_H_
...
public:
  ...
  void parseDocumentSettings(DocumentSettings& docSettings, int argc, char *argv[]);
  void dumpEnv() const;

};

#endif /* CTRLCUTOPTIONS_H_ */
