...
try "Installing dump backend..." "cp $CC_TEST_CODE/dump $BACKEND_PATH ; chmod u+x $BACKEND_PATH/dump"
try "Installing printer Name: $PRINTER PPD: $PPDFILE Device:$DEVICEURL..." "lpadmin -p $PRINTER -P $PPDFILE -v $DEVICEURL"
