...
static const char qt_meta_stringdata_NavigationView[] = {
    "NavigationView\0\0matrixUpdated()\0"
...
int NavigationView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: matrixUpdated(); break;
        case 1: updateSceneRect((*reinterpret_cast< const QRectF(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void NavigationView::matrixUpdated()
{
